...
(function patchMissingDomKeys() {
    ...
    const en = {
        ...
        leaderLabel: "LEADER",
        // driver template UI
        importDrivers: "Use Group Drivers",
        saveDrivers: "Save Group",
        savedDriverTemplates: "Group Drivers Pool",
        noSavedDrivers: "No group drivers yet. Add drivers and click \"Save Group\".",
        nameDriverTemplate: "Template name:",
        driversSaved: "Driver group saved",
        noDriversToSave: "No drivers to save",
        addDriversCustom: "Custom Add",
        addDriversPrompt: "Enter driver names (one per line or comma-separated):",
        driversAdded: "drivers added",
    ...
    const patch = {
        he: {
            ...
            leaderLabel: "מוביל",
            importDrivers: "בחירה ממאגר נהגים",
            saveDrivers: "שמור מאגר",
            savedDriverTemplates: "מאגר נהגי קבוצה",
            noSavedDrivers: "אין נהגי קבוצה שמורים. הוסף נהגים ולחץ \"שמור מאגר\".",
            nameDriverTemplate: "שם תבנית:",
            driversSaved: "מאגר הנהגים נשמר",
            noDriversToSave: "אין נהגים לשמירה",
            addDriversCustom: "הוספה מותאמת",
            addDriversPrompt: "הכנס שמות נהגים (שורה לכל נהג או מופרד בפסיקים):",
            driversAdded: "נהגים נוספו",
        },
        fr: {
            mute: "Son",
            ...
            leaderLabel: "LEADER",
            importDrivers: "Utiliser pilotes du groupe",
            saveDrivers: "Enregistrer groupe",
            savedDriverTemplates: "Pool pilotes groupe",
            noSavedDrivers: "Aucun pilote de groupe. Ajoutez des pilotes puis cliquez sur \"Enregistrer groupe\".",
            nameDriverTemplate: "Nom du modele :",
            driversSaved: "Groupe de pilotes enregistre",
            noDriversToSave: "Aucun pilote a enregistrer",
            addDriversCustom: "Ajout perso",
            addDriversPrompt: "Entrez les noms des pilotes (une ligne chacun ou separes par des virgules) :",
            driversAdded: "pilotes ajoutes",
        },
        pt: {
            mute: "Som",
            ...
            leaderLabel: "LÍDER",
            importDrivers: "Usar pilotos do grupo",
            saveDrivers: "Guardar grupo",
            savedDriverTemplates: "Pool de pilotos do grupo",
            noSavedDrivers: "Sem pilotos de grupo. Adicione pilotos e clique em \"Guardar grupo\".",
            nameDriverTemplate: "Nome do modelo:",
            driversSaved: "Grupo de pilotos guardado",
            noDriversToSave: "Sem pilotos para guardar",
            addDriversCustom: "Adicionar personalizado",
            addDriversPrompt: "Introduza nomes dos pilotos (uma linha por piloto ou separados por virgulas):",
            driversAdded: "pilotos adicionados",
        },
        ru: {
            mute: "Звук",
            ...
            leaderLabel: "ЛИДЕР",
            importDrivers: "Выбрать из группы",
            saveDrivers: "Сохранить группу",
            savedDriverTemplates: "Пул пилотов группы",
            noSavedDrivers: "Нет пилотов группы. Добавьте пилотов и нажмите \"Сохранить группу\".",
            nameDriverTemplate: "Название шаблона:",
            driversSaved: "Группа пилотов сохранена",
            noDriversToSave: "Нет пилотов для сохранения",
            addDriversCustom: "Пользовательское добавление",
            addDriversPrompt: "Введите имена пилотов (по одному в строке или через запятую):",
            driversAdded: "пилотов добавлено",
        },
        ar: {
            mute: "الصوت",
            ...
            leaderLabel: "المتصدر",
            importDrivers: "اختيار من مجموعة السائقين",
            saveDrivers: "حفظ المجموعة",
            savedDriverTemplates: "مجموعة سائقي الفريق",
            noSavedDrivers: "لا يوجد سائقو مجموعة بعد. أضف سائقين ثم اضغط \"حفظ المجموعة\".",
            nameDriverTemplate: "اسم القالب:",
            driversSaved: "تم حفظ مجموعة السائقين",
            noDriversToSave: "لا يوجد سائقون للحفظ",
            addDriversCustom: "إضافة مخصصة",
            addDriversPrompt: "أدخل أسماء السائقين (سطر لكل سائق أو مفصولة بفواصل):",
            driversAdded: "تمت إضافة سائقين",
        },
        es: {
            mute: "Sonido",
            ...
            leaderLabel: "LÍDER",
            importDrivers: "Usar pilotos del grupo",
            saveDrivers: "Guardar grupo",
            savedDriverTemplates: "Pool de pilotos del grupo",
            noSavedDrivers: "No hay pilotos de grupo. Agrega pilotos y pulsa \"Guardar grupo\".",
            nameDriverTemplate: "Nombre de plantilla:",
            driversSaved: "Grupo de pilotos guardado",
            noDriversToSave: "No hay pilotos para guardar",
            addDriversCustom: "Agregar personalizado",
            addDriversPrompt: "Ingresa nombres de pilotos (una linea por piloto o separados por comas):",
            driversAdded: "pilotos agregados",
        },
        it: {
            mute: "Audio",
            ...
            leaderLabel: "LEADER",
            importDrivers: "Usa piloti del gruppo",
            saveDrivers: "Salva gruppo",
            savedDriverTemplates: "Pool piloti del gruppo",
            noSavedDrivers: "Nessun pilota di gruppo. Aggiungi piloti e clicca \"Salva gruppo\".",
            nameDriverTemplate: "Nome modello:",
            driversSaved: "Gruppo piloti salvato",
            noDriversToSave: "Nessun pilota da salvare",
            addDriversCustom: "Aggiunta personalizzata",
            addDriversPrompt: "Inserisci i nomi piloti (una riga per pilota o separati da virgole):",
            driversAdded: "piloti aggiunti",
        },
        ka: {
            mute: "ხმა",
            ...
            leaderLabel: "ლიდერი",
            importDrivers: "ჯგუფის მძღოლებიდან არჩევა",
            saveDrivers: "ჯგუფის შენახვა",
            savedDriverTemplates: "ჯგუფის მძღოლების პული",
            noSavedDrivers: "ჯგუფის მძღოლები არ არის. დაამატეთ მძღოლები და დააჭირეთ \"ჯგუფის შენახვა\".",
            nameDriverTemplate: "შაბლონის სახელი:",
            driversSaved: "მძღოლების ჯგუფი შენახულია",
            noDriversToSave: "შესანახი მძღოლები არ არის",
            addDriversCustom: "კასტომ დამატება",
            addDriversPrompt: "შეიყვანეთ მძღოლების სახელები (თითო ხაზზე ან მძიმით გამოყოფილი):",
            driversAdded: "მძღოლები დამატებულია",
        },
        de: {
            mute: "Ton",
            ...
            importDrivers: "Fahrer aus Gruppe nutzen",
            saveDrivers: "Gruppe speichern",
            savedDriverTemplates: "Gruppen-Fahrerpool",
            noSavedDrivers: "Keine Gruppenfahrer vorhanden. Fahrer hinzufügen und auf \"Gruppe speichern\" klicken.",
            nameDriverTemplate: "Vorlagenname:",
            driversSaved: "Fahrergruppe gespeichert",
            noDriversToSave: "Keine Fahrer zum Speichern",
            addDriversCustom: "Benutzerdefiniert hinzufügen",
            addDriversPrompt: "Fahrernamen eingeben (eine Zeile pro Fahrer oder komma-getrennt):",
            driversAdded: "Fahrer hinzugefugt",
        },
        ja: {
            mute: "音声",
            raceHistory: "レース履歴",
            ...
            leaderLabel: "トップ",
            importDrivers: "グループから選択",
            saveDrivers: "グループ保存",
            savedDriverTemplates: "グループドライバープール",
            noSavedDrivers: "グループドライバーがありません。追加して「グループ保存」を押してください。",
            nameDriverTemplate: "テンプレート名:",
            driversSaved: "ドライバーグループを保存しました",
            noDriversToSave: "保存するドライバーがいません",
            addDriversCustom: "カスタム追加",
            addDriversPrompt: "ドライバー名を入力してください（1行1名またはカンマ区切り）:",
            driversAdded: "ドライバーを追加しました",
        },
        el: {
            mute: "Ήχος",
            ...
            leaderLabel: "ΠΡΩΤΟΣ",
            importDrivers: "Χρήση οδηγών ομάδας",
            saveDrivers: "Αποθήκευση ομάδας",
            savedDriverTemplates: "Πισίνα οδηγών ομάδας",
            noSavedDrivers: "Δεν υπάρχουν οδηγοί ομάδας. Προσθέστε οδηγούς και πατήστε \"Αποθήκευση ομάδας\".",
            nameDriverTemplate: "Όνομα προτύπου:",
            driversSaved: "Η ομάδα οδηγών αποθηκεύτηκε",
            noDriversToSave: "Δεν υπάρχουν οδηγοί για αποθήκευση",
            addDriversCustom: "Προσαρμοσμένη προσθήκη",
            addDriversPrompt: "Εισάγετε ονόματα οδηγών (μία γραμμή ανά οδηγό ή χωρισμένα με κόμμα):",
            driversAdded: "οδηγοί προστέθηκαν",
        },
    };
